...
export default function Landing() {
  ...
  return (
    <div className="bg-[#FCFFE5] h-[100vh] w-full">
      <div className="p-[3rem]">
        <p className="text-2xl font-black">TimeOut!</p>
      </div>
      <div className="flex w-full mt-[5rem] px-36">
        <div className="flex w-[45%] flex-col text-left">
          ...
          <p className="text-black opacity-80 text-lg font-bold mt-8 w-[60%]">
          ...
          <button
            ...
            className="px-6 mt-4 cursor-pointer py-2 rounded-md hover:bg-[#284eb6] bg-[#3c75cc] w-[40%] text-md hover:text-yellow-200 text-yellow-100 font-bold"
          >
